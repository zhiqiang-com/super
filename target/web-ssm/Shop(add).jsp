 ...
 <div id="header_top">
  ...
  <div class="Search">
        <div class="search_list">
            <ul>
                <li class="current"><a href="Product_list.jsp">宝贝</a></li>
                <li><a href="#">天猫</a></li>
   ...
   <form name="form0" id="form0" >
    ...
    <select size="1">
      <option value="2" selected="selected">市</option>
        <option value="bj">济宁</option>
        <option value="sh">青岛</option>
        <option value="sz">泰安</option>
        <option value="xg" >滕州</option>

    </select></span>
    <select size="1">
      <option value="3" selected="selected" >县/区</option>
        <option value="bj">嘉祥</option>
        <option value="sh">单县</option>
        <option value="sz">金乡</option>
        <option value="xg" >滕州</option>
...
　　　　　　<input type="file" class="file-uploader" name="uploadDataField" class="FileUploader"/>
　　　　　　<div class="file-uploader-wrap-fake"> 
　　　　　　　　<input type="text" class="PathDisplayer" class="input-text" disabled />
...
　　　　　　</div>
       ...
       <img  class="showimg" src=""  alt="预览图片"  class="Preview showimg1"/>
      </div>
      </div>
     </li>
...
<a href="CompanyZZ.jsp" class="Next_btn">下一步，填写店铺及公司资质</a>
   </ul>
  </div>
  </div>
</div>
