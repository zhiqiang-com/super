 ...
 <div id="header_top">
  <div id="top">
    <div class="Inside_pages">
      <div class="Collection"><a href="login.jsp" class="green">请登录</a> <a href="#" class="green">免费注册</a></div>
...
<!--面包屑-->
 <div class="Location_link">
  <em></em><a href="index.jsp">首页</a>  &lt;   <a href="PublicGoods.jsp">公共产品库</a>
 </div>
  ...
  <div class="Sorted_style">
   ...
   <div class="k_list">
	...
	<div class="Borders">
	 ...
	 <div class="name"><a href="Products_list.jsp">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
	 <div class="p-operate">
	  <a href="#" class="p-o-btn shop_cart">加入店铺</a>
	 </div>
	 </div>
	</li>
      <li class="gl-item">
    ...
    <em class="icon_special tejia"></em>
	<div class="Borders">
	 <div class="img"><a href="Products_list.jsp"><img src=Demo/products/p_6.jpg" style="width:220px;height:220px"></a></div>
	 <div class="name"><a href="Products_list.jsp">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
	 <div class="p-operate">
	  <a href="#" class="p-o-btn shop_cart">加入店铺</a>
    ...
    <em class="icon_special tejia"></em>
	<div class="Borders">
	 <div class="img"><a href="Products_list.jsp"><img src="Demo/products/p_7.jpg" style="width:220px;height:220px"></a></div>
	 <div class="name"><a href="Products_list.jsp">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
	 <div class="p-operate">
	  <a href="#" class="p-o-btn shop_cart">加入店铺</a>
    ...
    <em class="icon_special tejia"></em>
	<div class="Borders">
	 <div class="img"><a href="Product_detailed.jsp"><img src="Demo/products/p_12.jpg" style="width:220px;height:220px"></a></div>
    ...
    <em class="icon_special tejia"></em>
	<div class="Borders">
	 <div class="img"><a href="Product_detailed.jsp"><img src="Demo/products/p_53.jpg" style="width:220px;height:220px"></a></div>
	 <div class="name"><a href="Product_detailed.jsp">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
	 <div class="p-operate">
	  <a href="#" class="p-o-btn shop_cart">加入店铺</a>
    ...
    <em class="icon_special tejia"></em>
	<div class="Borders">
	 <div class="img"><a href="Product_detailed.jsp"><img src="Demo/products/p_7.jpg" style="width:220px;height:220px"></a></div>
	 <div class="name"><a href="Product_detailed.jsp">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
	 <div class="p-operate">
	  <a href="#" class="p-o-btn shop_cart">加入店铺</a>
    ...
    <em class="icon_special tejia"></em>
	<div class="Borders">
	 <div class="img"><a href="Product_detailed.jsp"><img src="Demo/products/p_9.jpg" style="width:220px;height:220px"></a></div>
	 <div class="name"><a href="Product_detailed.jsp">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
	 <div class="p-operate">
	  <a href="#" class="p-o-btn shop_cart">加入店铺</a>
