...
<script src="Demo/js/jquery.simpleGal.js"></script>
<script type="text/javascript" src="Demo/js/jquery.imagezoom.min.js"></script>
<style>
img {
	max-width: none;
}
...
.addbtn {
	width: 22px;
	height: 22px;
	background: url(Demo/images/close2.png) no-repeat;
	margin-right: 5px;
	margin-top: 3px;
	border: none;
	float: right;
...
<div class="clear wrapper header">
    ...
    <div class="search float-lt">
        ...
        <div class="clear search_cur">
            ...
            <ul>
                <li class="search_btn"><a href="Products_list.jsp">搜索</a></li>
            </ul>
        </div>
...
<div class="sup-wid">
    ...
    <div class="pro_detail" >
        <div class="pro_detail_img float-lt">
            <div class="gallery">
                <div class="tb-booth tb-pic tb-s310"> <a href="Demo/images/01.jpg"><img src="Demo/images/01_mid.jpg" alt="展品细节展示放大镜特效" rel="images/01.jpg" class="jqzoom" /></a>
                    <%--<a href="Demo/images/02.jpg"><img src="Demo/images/02_mid.jpg" alt="展品细节展示放大镜特效" rel="images/02.jpg" class="jqzoom" /></a>--%>
                    <%--<a href="Demo/images/03.jpg"><img src="Demo/images/03_mid.jpg" alt="展品细节展示放大镜特效" rel="images/03.jpg" class="jqzoom" /></a>--%>
                    <%--<a href="Demo/images/04.jpg"><img src="Demo/images/04_mid.jpg" alt="展品细节展示放大镜特效" rel="images/04.jpg" class="jqzoom" /></a>--%>
                </div>

                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40"><a href="#"><img src="Demo/images/01_small.jpg" mid="Demo/images/01_mid.jpg" big="images/01.jpg"></a></div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40"><a href="#"><img src="Demo/images/02_small.jpg" mid="images/02_mid.jpg" big="images/02.jpg"></a></div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40"><a href="#"><img src="Demo/images/03_small.jpg" mid="images/03_mid.jpg" big="images/03.jpg"></a></div>
                    </li>
                    <li style="margin-right:0px;">
                        <div class="tb-pic tb-s40"><a href="#"><img src="Demo/images/04_small.jpg" mid="images/04_mid.jpg" big="images/04.jpg"></a></div>
                    </li>
                </ul>
            </div>
            <script type="text/javascript">
        $(function(){
            ...
            <input type="button" value="加入收藏" i2015新茶  江苏省镇江市特产 d="h1" class="addcart" onclick="ShowDiv('MyDiv2','fade2')" />
        </div>
        <div class="float-lt pro_detail_con">
            <div class="pro_detail_tit">  茅山长青   高档铁盒礼盒   色泽绿匀  香气纯正</div>
            ...
            <div class="pro_detail_score margin-t20">
                ...
                <ul>
                    <li style="width:16px; height:16px;"><img src="Demo/images/iconfont-xingxingman.png" width="16" height="16" /></li>
                    <li style="width:16px; height:16px;"><img src="Demo/images/iconfont-xingxingman.png" width="16" height="16" /></li>
                    <li style="width:16px; height:16px;"><img src="Demo/images/iconfont-xingxingman.png" width="16" height="16" /></li>
                    <li style="width:16px; height:16px;"><img src="Demo/images/iconfont-xingxingman.png" width="16" height="16" /></li>
                    <li style="width:16px; height:16px;"><img src="Demo/images/iconfont-xingxingkong.png" width="16" height="16" /></li>
                </ul>
            </div>
            <div class="clear"></div>
            ...
            <div class="yushou">
                <div class="fl font24">售价：<strong>30.99元</strong></div>
                <div class="fr fashou">2016年04月05日 发售</div>
            </div>
            <div class="clear"></div>
            ...
            <div class="pro_detail_btn margin-t30">
                <ul>
                    <li class="pro_detail_shop"><a href="Shop_cart.jsp">立即购买</a></li>
                    <li class="pro_detail_add"><a href="Shop_cart.jsp" onclick="ShowDiv('MyDiv','fade')">加入购物车</a></li>
                </ul>
            </div>
        </div>
        <div class="float-rt pro_right">
            <div align="center">
                <p><img src="Demo/images/lmrz.png" /></p>
                <p class="margin-t10">普通会员</p>
            </div>
            <div align="center"><img src="Demo/images/pro_V2_r6_c9.png" />
                <p class="line-ht20">信用度</p>
                <p class="line-ht20" style="color:#ec3c36;">2.5</p>
            </div>
            <div align="center"><img src="Demo/images/pro_V2_r8_c10.png" />
                <p class="line-ht30">在线联系</p>
            </div>
            <div align="center"><img src="Demo/images/pro_V2_r8_c9.png" />
            ...
            <div class="conbox">
                <div class="pro_judge">
                    ...
                    <table width="100%" border="0">
                        <tr>
                            <td width="80" align="left"><a href="" rel="images/01_mid.jpg" class="preview"><img src="Demo/images/01_mid.jpg" width="60" height="60" class="border_gry" /></a></td>
    ...
    <div class="hotpro">
        ...
        <div class="hotpro_box">
            <div class="pro-view-hot">
                <ul>
                    <li class="pro-img"><a href="#"><img src="Demo/images/p_032.jpg" /></a></li>
                    <li class="price"><strong>￥ 36.00</strong><span>已销售227</span></li>
                    <li><a href="#" class="title">恒顺蜂蜜醋  10ml*24支 纯粮酿造 镇江香醋 江苏特产 礼盒礼品 </a></li>
                </ul>
                <ul>
                    <li class="pro-img"><a href="#"><img src="Demo/products/p_39.jpg" /></a></li>
                    <li class="price"><strong>￥ 36.00</strong><span>已销售227</span></li>
                    <li><a href="#" class="title">恒顺蜂蜜醋  10ml*24支 纯粮酿造 镇江香醋 江苏特产 礼盒礼品 </a></li>
                </ul>
                <ul>
                    <li class="pro-img"><a href="#"><img src="Demo/products/p_42.jpg" /></a></li>
                    <li class="price"><strong>￥ 36.00</strong><span>已销售227</span></li>
                    <li><a href="#" class="title">恒顺蜂蜜醋  10ml*24支 纯粮酿造 镇江香醋 江苏特产 礼盒礼品 </a></li>
                </ul>
                <ul>
                    <li class="pro-img"><a href="#"><img src="Demo/products/p_9.jpg" /></a></li>
                    <li class="price"><strong>￥ 36.00</strong><span>已销售227</span></li>
                    <li><a href="#" class="title">恒顺蜂蜜醋  10ml*24支 纯粮酿造 镇江香醋 江苏特产 礼盒礼品 </a></li>
                </ul>
                <ul>
                    <li class="pro-img"><a href="#"><img src="Demo/products/p_12.jpg" /></a></li>
                    <li class="price"><strong>￥ 36.00</strong><span>已销售227</span></li>
                    <li><a href="#" class="title">恒顺蜂蜜醋  10ml*24支 纯粮酿造 镇江香醋 江苏特产 礼盒礼品 </a></li>
                </ul>
    ...
    <div class="helper">
        <div class="mod">
            <div class="mod-wrap">
                <h4><img src="Demo/images/h1.png" width="60" height="60" /><span>新手上路</span> </h4>
            </div>
        </div>
        <div class="mod">
            <div class="mod-wrap">
                <h4><img src="Demo/images/h2.png" width="60" height="60" /><span>如何支付</span> </h4>
            </div>
        </div>
        <div class="mod">
            <div class="mod-wrap">
                <h4><img src="Demo/images/h3.png" width="60" height="60" /><span>配送运输</span> </h4>
            </div>
        </div>
        <div class="mod mod-last">
            <div class="mod-wrap">
                <h4><img src="Demo/images/h4.png" width="60" height="60" /><span>售后服务</span> </h4>
            </div>
        </div>
        <div class="mod mod-last">
            <div class="mod-wrap">
                <h4><img src="Demo/images/h5.png" width="60" height="60" /><span>联系我们</span> </h4>
            </div>
        </div>
    </div>
