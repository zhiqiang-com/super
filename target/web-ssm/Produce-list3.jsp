        ...
        <div id="header"  class="header page_style">
            ...
            <div class="hd_Shopping_list" id="Shopping_list">
                ...
                <div class="dorpdown-layer">
                    ...
                    <ul class="p_s_list">
                        <li>
                            <div class="img"><img src="Demo/images/p_032.jpg"></div>
                            <div class="content">
                    ...
                    <div class="Shopping_style">
                        ...
                        <a href="Shop_cart.jsp" title="去购物车结算" id="btn-payforgoods" class="Shopping">去购物车结算</a> </div>
                </div>
            </div>
        </div>
        <!--菜单栏-->
    ...
    <div class="p_list  clearfix">
        <ul>
            <li class="gl-item"> <em class="icon_special tejia"></em>
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_56.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>橙子</a></div>
                    <div class="Shop_name"><a href="#">橙子旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>20</strong></div>
                        <div class="fl sold">
                            <div><del class="orig-price">¥50.00</del></div>
                            <div class="sold-num"><em>20</em>个已付款</div>
                        </div>
                        <a href="">
            ...
            <li class="gl-item"> <em class="icon_special tejia"></em>
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_2.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>苹果</a></div>
                    <div class="Shop_name"><a href="#">苹果旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>25</strong></div>
                        <div class="fl sold">
                            <div><del class="orig-price">¥60.00</del></div>
                            <div class="sold-num"><em>20</em>个已付款</div>
                        </div>
                        <a href="">
                            <div class="fr sold-go">抢购</div>
            ...
            <li class="gl-item"> <em class="icon_special tejia"></em>
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_1.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
            ...
            <li class="gl-item">
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_42.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
                    <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>89</strong></div>
            ...
            <li class="gl-item"> <em class="icon_special xinping"></em>
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_9.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
                    <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>89</strong></div>
            ...
            <li class="gl-item">
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_6.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
                    <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>89</strong></div>
            ...
            <li class="gl-item">
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_51.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
                    <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>89</strong></div>
            ...
            <li class="gl-item">
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_8.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
                    <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>89</strong></div>
            ...
            <li class="gl-item">
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_31.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
                    <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>89</strong></div>
            ...
            <li class="gl-item">
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_33.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
                    <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>89</strong></div>
            ...
            <li class="gl-item">
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_32.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
                    <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>89</strong></div>
            ...
            <li class="gl-item">
                <div class="Borders">
                    <div class="img"><a href="Product_list1.jsp"><img src="Demo/products/p_7.jpg" style="width:220px;height:220px"></a></div>
                    <div class="name"><a href="Products_list.jsp"><strong style="color:#ff7200;">【预售】</strong>乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
                    <div class="Shop_name"><a href="#">三只松鼠旗舰店</a></div>
                    <div class="yushou">
                        <div class="yushou-p fl">¥<strong>89</strong></div>
        ...
        <div class="Paging">
            <div class="Pagination"> <a href="index.jsp">首页</a> <a href="#" class="pn-prev disabled">&lt;上一页</a> <a href="#" class="on">1</a> <a href="#">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#">下一页&gt;</a> <a href="#">尾页</a> </div>
        </div>
    </div>
</div>
<!--网站地图-->
