...
<div class="user_style clearfix">
 ...
 <div class="left_style">
  ...
  <div class="title_style"><em></em>产品预订</div> 
   <div class="Booking_style">
    <div class="Note">注：预订产品不和其他商品一起结算，只能单独结算，提前付款者，到货后商品第一时间发货，无需再次下单，并享受多从优惠。</div>
       ...
       <table>
         <thead>
          ...
          <tbody>       
           ...
           <input name="" type="checkbox" value=""  class="checkbox"/>下单时间：2015-12-3 | 订单号：445454654654654 <span class="Time_left">剩余时间：2天4小时34分23秒</span>
           </td>
           </tr>
           ...
           <td class="split_line">25.00</td>
           <td>2</td>   
           <td class="split_line">100</td>
           <td class="split_line"><p style="color:#F30">已预订，并付款</p></td>
           <td class="operating">
             <a href="#">查看订单</a>
             <a href="#">查看物流</a>
             <a href="#">联系客服</a>
           ...
           <td>2</td>   
           <td class="split_line">100</td>
           <td class="split_line"><p style="color:#F30">已预订，未付款</p></td>
           <td class="operating">
             <a href="#">查看订单</a>
             <a href="#">立即付款</a>
             <a href="#">联系客服</a>
