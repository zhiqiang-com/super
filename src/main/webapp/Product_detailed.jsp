...
<div class="sup-wid">
    ...
    <div class="pro_detail" >
        <div class="pro_detail_img float-lt">
            <div class="gallery">
                <div class="tb-booth tb-pic tb-s310"> <a href="Demo/images/01.jpg"><img src="Demo/images/01_mid.jpg" alt="展品细节展示放大镜特效" rel="images/01.jpg" class="jqzoom" /></a> </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40"><a href="#"><img src="Demo/images/01_small.jpg" mid="images/01_mid.jpg" big="images/01.jpg"></a></div>
                    </li>
                    <li>
        ...
        <div class="float-lt pro_detail_con">
            ...
            <div class="pro_detail_btn margin-t30">
                <ul>
                    <li class="pro_detail_shop"><a href="pay1.jsp">立即购买</a></li>
    ...
    <div class="hotpro">
        ...
        <div class="hotpro_box">
            <div class="pro-view-hot">
                <ul>
                    <li class="pro-img"><a href="#"><img src="Demo/images/pro-1.jpg" /></a></li>
