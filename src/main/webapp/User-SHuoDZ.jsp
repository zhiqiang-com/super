  ...
  <div id="top">
	...
	<div class="hd_top_manu clearfix">
	  <ul class="clearfix">
          ...
          <li class="hd_menu_tit" data-addclass="hd_menu_hover"><a href="Shop_cart.jsp">我的购物车<b></li>
	  </ul>
	</div>
    </div>
  </div>
  ...
  <div class="user_address_style">
   ...
   <div class="add_address">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
     ...
     <tr><td class="label_name">所在地区：
             <%--<option value="bj">北京</option>--%>
             <%--<option value="sh">上海</option>--%>
             <%--<option value="sz">深圳</option>--%>
             <%--<option value="xg" selected="selected">香港</option>--%>
     </td><select size="1">
