...
<!--内容详细-->
   <div class="title_style"><em></em>店铺公告</div>
    <div class="content_style">
      <div class="Bulletin_style">
        <div class="Bulletin_operating"><a href="FB.jsp" class="add_Bulletin">发布公告</a><a href="#" class="return_shops">返回店铺主页</a></div>
        <div class="Bulletin_list">
         <ul class="list">
          <li class="Bulletin_content">
           <p class="Bulletin_time">更新于2016-4-6 10:23:12</p>
           ...
           <p class="Bulletin_btn"><a href="#" class="Modify_cz">修改</a><a href="#" class="Delete_z">删除</a></p>
          </li>
           <li class="Bulletin_content">
           <p class="Bulletin_time">更新于2016-4-6 10:23:12</p>
           <p>公告，是指政府、团体对重大事件当众正式公布或者公开宣告，宣布。国务院2012年4月16日发布、2012年7月1日起施行的《党政机关公文处理工作条例》，对公告的使用表述为:"适用于向国内外宣布重要事项或者法定事项"。其中包含两方面的内容:一是向国内外宣布重要事项，公布依据政策、法令采取的重大行动等;二是向国内外宣布法定事项，公布依据法律规定告知国内外的有关重要规定和重大行动等。</p>
