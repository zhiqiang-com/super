  ...
  <div id="top">
	...
	<div class="hd_top_manu clearfix">
	  <ul class="clearfix">
          ...
          <li class="hd_menu_tit" data-addclass="hd_menu_hover"><a href="Shop_cart.jsp">我的购物车</a></li>
	  </ul>
	</div>
    </div>
  </div>
     ...
     <dl class="accountSideOption1">
      ...
      <dd>
        <ul>
          ...
          <li> <a href="User-SHuoDZ.jspl">收货地址</a></li>
          <li> <a href="#">缺货登记</a></li>
          <li><a href="#">跟踪包裹</a></li>
        </ul>
      </dd>
     ...
     <!--个人信息-->
      <div class="Personal_info" id="Personal">
         ...
         <ul class="Head_portrait">
          <li class="User_avatar"><img src="Demo/images/people.png" /></li>
